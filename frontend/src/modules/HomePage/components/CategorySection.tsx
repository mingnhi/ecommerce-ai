              ...
              return (
                ...
                >
                  <motion.button
                    ...
                    className={cn(
                      "group flex h-full min-h-[106px] w-full flex-col items-center justify-center rounded-2xl border p-4 text-center transition-all duration-500 hover:cursor-pointer relative overflow-hidden",
                      activeTab === cat.name
