        ...
        <div className="space-y-5 p-4">
          ...
          <div className="space-y-3 rounded-lg bg-muted/30 p-4">
            ...
            <div className="flex items-center justify-between border-t border-border/40 pt-3">
              ...
              <span className="text-xl font-bold tabular-nums text-sky-500">
          ...
          <Button
            ...
            onClick={() => router.push(checkoutUrl(Array.from(selected)))}
            className="h-11 w-full cursor-pointer rounded-lg bg-sky-500 text-base font-semibold text-white shadow-md shadow-sky-600/20 hover:bg-sky-600 disabled:cursor-not-allowed disabled:opacity-50 hover:cursor-pointer"
          >
            Mua hàng
          </Button>
        </div>
