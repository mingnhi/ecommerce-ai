  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={cn("h-full w-full border-4 border-black dark:border-white rounded-2xl flex items-center justify-center px-4", colorClass)}>
            <span className="text-black font-black text-3xl italic tracking-normal" style={{ fontFamily: 'Impact, sans-serif' }}>
              {card.name}
            </span>
          </div>
        </motion.div>
        ...
        >
          <div className={cn("h-full w-full border-4 border-black dark:border-white rounded-2xl flex items-center justify-center px-4", backColorClass)}>
            <span className="text-black font-black text-3xl not-italic tracking-normal" style={{ fontFamily: 'Impact, sans-serif' }}>
              {card.name}
            </span>
          </div>
        </motion.div>
